class HashServerStatus {
  ...
  HashServerStatus(this._state, this._message);
  HashServerStatus.starting() : _state = STARTING;
  HashServerStatus.started(this._port) : _state = STARTED;
  HashServerStatus.stopping() : _state = STOPPING;
  HashServerStatus.stopped() : _state = STOPPED;
  HashServerStatus.error([this._error]) : _state = ERROR;
